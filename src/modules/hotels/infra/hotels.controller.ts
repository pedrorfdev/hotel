import { Controller, Get, Post, Body, Patch, Delete, Query, UseGuards, UploadedFile, Param, ParseFilePipe, FileTypeValidator, MaxFileSizeValidator, UseInterceptors } from '@nestjs/common';
